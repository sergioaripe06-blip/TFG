...
public class CollectionsService {
    ...
    public CollectionsService(@NonNull FirebaseFirestore db) {
        this.db = db;
    }

    public void loadCollectionsByGroup(
        ...
        db.collection("rent_collections")
                ...
                .addOnFailureListener(e -> onError.onError(e == null ? "No se pudieron cargar cobros" : e.getMessage()));
    }
}
